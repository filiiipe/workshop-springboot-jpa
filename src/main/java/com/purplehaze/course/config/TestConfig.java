package com.purplehaze.course.config;
...
import com.purplehaze.course.entities.Payment;
import com.purplehaze.course.entities.Product;
import com.purplehaze.course.entities.User;
import com.purplehaze.course.entities.enums.OrderStatus;
import com.purplehaze.course.repositories.CategoryRepository;
import com.purplehaze.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Payment pay = new Payment(null, Instant.parse("2019-07-21T05:42:10Z"), o2);
		o2.setPayment(pay);
